    ...
    public partial class AssignmentsEntities : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_assignment_collaborators", x => x.assignment_collaborator_id);
                    table.ForeignKey(
                        name: "FK_assignment_collaborators_collaborators_collaborator_id",
            ...
            migrationBuilder.CreateTable(
                name: "assignments_machinery",
                schema: "public",
                columns: table => new
                {
                    assignment_machinery_id = table.Column<Guid>(type: "uuid", nullable: false, defaultValueSql: "gen_random_uuid()"),
                    operational_order_id = table.Column<Guid>(type: "uuid", nullable: false),
                    machinery_id = table.Column<Guid>(type: "uuid", nullable: false),
                    is_active = table.Column<bool>(type: "boolean", nullable: false, defaultValue: true),
                    deleted_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    created_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValueSql: "CURRENT_TIMESTAMP")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_assignments_machinery", x => x.assignment_machinery_id);
                    table.ForeignKey(
                        name: "FK_assignments_machinery_machineries_machinery_id",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_operational_orders_company_id",
                schema: "public",
                table: "operational_orders",
                column: "company_id");

            migrationBuilder.CreateIndex(
                name: "ix_assignment_collaborators_collaborator_id",
                schema: "public",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_assignments_machinery_machinery_id",
                schema: "public",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_operational_orders_companies_company_id",
                schema: "public",
                table: "operational_orders",
                column: "company_id",
                principalSchema: "public",
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    machinery_id = table.Column<Guid>(type: "uuid", nullable: true),
