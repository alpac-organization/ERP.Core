...
namespace ERP.Core.Manager.Api.Infrastructure.Persistence.Database.Migrations
{
    ...
    [Migration("20260622205802_ReajusteDeEntidadesAlmacen")]
    partial class ReajusteDeEntidadesAlmacen
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ERP.Core.Database.Domain.Entities.Catalogs.CatalogWarehouse", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("catalog_warehouse", "public");
                });
            ...
            modelBuilder.Entity("ERP.Core.Database.Domain.Entities.Catalogs.Location", b =>
                {
                    ...
                    b.Property<Guid>("AssistanceControlId")
                        .HasColumnType("uuid");

                    b.Property<Guid>("AssistanceControlId1")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("AssistanceControlId1");
            ...
            modelBuilder.Entity("ERP.Core.Database.Domain.Entities.Warehouse.Customer", b =>
                {
                    ...
                    b.Property<Guid>("CatalogWarehouseId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ERP.Core.Database.Domain.Entities.Catalogs.CatalogWarehouse", b =>
                {
                    b.HasOne("ERP.Core.Database.Domain.Entities.Catalogs.CatalogWarehouse", "Parent")
                        .WithMany("Children")
            ...
            modelBuilder.Entity("ERP.Core.Database.Domain.Entities.Catalogs.Location", b =>
                {
                    b.HasOne("ERP.Core.Database.Domain.Entities.Payrolls.AssistanceControl", "AssistanceControl")
                        .WithMany()
                        .HasForeignKey("AssistanceControlId1")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.Navigation("AssistanceControl");
            ...
            modelBuilder.Entity("ERP.Core.Database.Domain.Entities.Warehouse.Customer", b =>
                {
                    b.HasOne("ERP.Core.Database.Domain.Entities.Catalogs.CatalogWarehouse", "CatalogWarehouse")
                        .WithOne()
                        .HasForeignKey("ERP.Core.Database.Domain.Entities.Warehouse.Customer", "CatalogWarehouseId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("CatalogWarehouse");
                });
            ...
            modelBuilder.Entity("ERP.Core.Database.Domain.Entities.Warehouse.Product", b =>
                {
                    b.HasOne("ERP.Core.Database.Domain.Entities.Catalogs.CatalogWarehouse", "CatalogWarehouse")
                        .WithMany()
                        .HasForeignKey("CatalogWarehouseId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
