...
{
    /// <inheritdoc />
    public partial class RefactorMachineryEntity : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    machinery_id = table.Column<Guid>(type: "uuid", nullable: false, defaultValueSql: "gen_random_uuid()"),
                    ...
                    status = table.Column<int>(type: "machinery_status_enum", nullable: false, defaultValueSql: "'available'::machinery_status_enum"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_machineries", x => x.machinery_id);
                    table.ForeignKey(
                        name: "FK_machineries_branches_branch_id",
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    assigned_operator_id = table.Column<Guid>(type: "uuid", nullable: true),
                    branch_id = table.Column<Guid>(type: "uuid", nullable: false),
                    brand = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    code = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    ...
                    hour_meter = table.Column<decimal>(type: "numeric", nullable: false),
                    ...
                    load_capacity_kg = table.Column<decimal>(type: "numeric", nullable: false),
                    ...
                    max_reach_height_meters = table.Column<decimal>(type: "numeric", nullable: true),
                    model = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_machinery_catalogs", x => x.id);
                });
