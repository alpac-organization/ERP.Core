...
{
    /// <inheritdoc />
    public partial class AgregarContizacionesUnidadesMedida : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    quotation_id = table.Column<Guid>(type: "uuid", nullable: false, defaultValueSql: "gen_random_uuid()"),
                    made_by = table.Column<string>(type: "text", nullable: false),
                    quote_date = table.Column<DateOnly>(type: "date", nullable: false),
                    observations = table.Column<string>(type: "text", nullable: true),
                    approximate_cost_total = table.Column<decimal>(type: "numeric(18,0)", precision: 18, scale: 0, nullable: false),
                    additional_date = table.Column<string>(type: "jsonb", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    unit_measure_id = table.Column<Guid>(type: "uuid", nullable: false, defaultValueSql: "gen_random_uuid()"),
                    code = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: true),
                    name = table.Column<string>(type: "text", nullable: false),
                    symbol = table.Column<string>(type: "character varying(10)", maxLength: 10, nullable: true),
                    description = table.Column<string>(type: "text", nullable: true),
                    unit_measure_type = table.Column<int>(type: "unit_measure_type_enum", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_units_measurement", x => x.unit_measure_id);
                });
        }
