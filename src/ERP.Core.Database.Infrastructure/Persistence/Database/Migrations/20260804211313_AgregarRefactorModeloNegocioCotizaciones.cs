...
{
    /// <inheritdoc />
    public partial class AgregarRefactorModeloNegocioCotizaciones : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.RenameIndex(
                ...
                schema: "public",
                table: "quoted_products",
                newName: "IX_quoted_products_quotation_id");
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.RenameColumn(
                ...
                schema: "public",
                table: "quoted_products",
                newName: "quote_detail_id");

            migrationBuilder.RenameIndex(
                name: "IX_quoted_products_quotation_id",
                schema: "public",
                table: "quoted_products",
                newName: "IX_quoted_products_quote_detail_id");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    approximate_total_cost = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                    created_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValueSql: "CURRENT_TIMESTAMP"),
                    deleted_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    quotation_status = table.Column<int>(type: "quotation_status_enum", nullable: false)
                },
                constraints: table =>
                {
