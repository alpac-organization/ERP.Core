...
namespace ERP.Core.Database.Infrastructure.Persistence.Database.Migrations
{
    ...
    [Migration("20260925001917_AgregarMetodosPagoQueAceptaUnProveedor")]
    partial class AgregarMetodosPagoQueAceptaUnProveedor
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "public", "product_quality_enum", new[] { "excellent", "good", "regular", "poor", "damaged" });
            ...
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "public", "rack_status_enum", new[] { "available", "occupied", "under_maintenance", "blocked", "reserved" });
            ...
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "public", "section_storage_type_enum", new[] { "racks", "lots", "pallets", "none" });
            ...
            modelBuilder.Entity("ERP.Core.Database.Domain.Entities.Bases.BaseCapacity", b =>
                {
                    ...
                    b.Property<decimal>("AvailableAreaWithMarginM2")
                        .HasPrecision(18, 2)
                    ...
                    b.Property<decimal>("OccupiedChargeableAreaM2")
                        .HasPrecision(18, 2)
                        .HasColumnType("numeric(18,2)")
                        .HasColumnName("occupied_chargeable_area_m2");

                    b.Property<decimal>("PercentageAvailableAreaWithMarginM2")
                        .HasPrecision(5, 2)
                    ...
                    b.Property<decimal>("UnoccupiedChargeableAreaM2")
                        .HasPrecision(18, 2)
                        .HasColumnType("numeric(18,2)")
                        .HasColumnName("unoccupied_chargeable_area_m2");

                    b.Property<decimal>("UnusedAreaM2")
                        .HasPrecision(18, 2)
                        .HasColumnType("numeric(18,2)")
            ...
            modelBuilder.Entity("ERP.Core.Database.Domain.Entities.Bases.BaseCoordinates", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("ERP.Core.Database.Domain.Entities.Bases.BasePositionsPallets", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<bool>("AllowsStocking")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(true)
            ...
            modelBuilder.Entity("ERP.Core.Database.Domain.Entities.Catalogs.CustomsBranches", b =>
                {
                    ...
                    b.Property<string>("CustomsBranchName")
                        .HasColumnType("text")
            ...
            modelBuilder.Entity("ERP.Core.Database.Domain.Entities.Catalogs.Sections", b =>
                {
                    ...
                    b.Property<bool?>("AllowsStorageAisle")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false)
                    ...
                    b.Property<bool?>("IsStorageEnabledAisle")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false)
                        .HasColumnName("is_storage_enable_aisle");

                    b.Property<int?>("MaxPalletsPerLevelAisle")
                        .HasColumnType("integer")
                        .HasColumnName("max_pallets_per_level_aisle");

                    b.Property<int>("SectionStorageType")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("ERP.Core.Database.Domain.Entities.Catalogs.WorkArea", b =>
                {
                    ...
                    b.Property<string>("WorkAreaCode")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)")
            ...
            modelBuilder.Entity("ERP.Core.Database.Domain.Entities.Operations.Invoice", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("ERP.Core.Database.Domain.Entities.Operations.OperationalOrder", b =>
                {
                    ...
                    b.ToTable("operational_orders", "public");
                });
            ...
            modelBuilder.Entity("ERP.Core.Database.Domain.Entities.Operations.OperationalService", b =>
                {
                    ...
                    b.ToTable("operational_services", "public");
                });

            modelBuilder.Entity("ERP.Core.Database.Domain.Entities.Operations.ServicesOrder", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("ERP.Core.Database.Domain.Entities.Shopping.Quotation", b =>
                {
                    ...
                    b.Property<decimal?>("AvailabilityTime")
                        .HasPrecision(18, 2)
                        .HasColumnType("numeric(18,2)")
                        .HasColumnName("availability_time");

                    b.Property<int?>("AvailabilityTimeType")
                    ...
                    b.Property<string>("SupplierSelectionJustification")
                        .HasMaxLength(300)
                        .HasColumnType("character varying(300)")
            ...
            modelBuilder.Entity("ERP.Core.Database.Domain.Entities.Shopping.SupplierBankAccount", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("AccountHolderIdentification")
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)")
                    ...
                    b.ToTable("supplier_bank_accounts", "public");
                });
            ...
            modelBuilder.Entity("ERP.Core.Database.Domain.Entities.Shopping.SupplierDetails", b =>
                {
                    ...
                    b.Property<bool>("ApplyIrRetention")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(true)
                        .HasColumnName("apply_ir_retention");

                    b.Property<bool>("ApplyMunicipalRetention")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(true)
                    ...
                    b.Property<string>("ExclusiveBrandsOrParts")
                        .HasColumnType("text")
            ...
            modelBuilder.Entity("ERP.Core.Database.Domain.Entities.Warehouse.ReceptionTransportEntrance", b =>
                {
                    ...
                    b.Property<Guid>("ReceptionEntranceId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ReceptionEntranceId")
                        .IsUnique();
            ...
            modelBuilder.Entity("ERP.Core.Database.Domain.Entities.Warehouse.WarehouseCapacity", b =>
                {
                    ...
                    b.Property<decimal?>("AvailableVolumenWithMarginM3")
                        .HasPrecision(18, 2)
                        .HasColumnType("numeric(18,2)")
                        .HasColumnName("available_volumen_with_margin_m3");

                    b.Property<bool>("HasMargins")
                        .HasColumnType("boolean")
                    ...
                    b.Property<decimal?>("OccupiedChargeableVolumenM3")
                        .HasPrecision(18, 2)
                        .HasColumnType("numeric(18,2)")
                        .HasColumnName("occupied_chargeable_volumen_m3");

                    b.Property<decimal>("PercentageAvailableVolumenWithMarginM3")
                        .HasPrecision(5, 2)
                        .HasColumnType("numeric(5,2)")
                        .HasColumnName("percentage_available_volumen_with_margin_m3");

                    b.Property<decimal?>("TotalVolumenM3")
                        .HasPrecision(18, 2)
                        .HasColumnType("numeric(18,2)")
                        .HasColumnName("total_volumen_m3");

                    b.Property<decimal?>("UnoccupiedChargeableVolumenM3")
                        .HasPrecision(18, 2)
                        .HasColumnType("numeric(18,2)")
                        .HasColumnName("unoccupied_chargeable_volumen_m3");

                    b.Property<decimal?>("UnusedVolumenM3")
                        .HasPrecision(18, 2)
                        .HasColumnType("numeric(18,2)")
            ...
            modelBuilder.Entity("ERP.Core.Database.Domain.Entities.Catalogs.LotsCoordinates", b =>
                {
            ...
            modelBuilder.Entity("ERP.Core.Database.Domain.Entities.Catalogs.SectionCoordinates", b =>
                {
                    ...
                    b.ToTable("section_coordinates", "public");
                });

            modelBuilder.Entity("ERP.Core.Database.Domain.Entities.Catalogs.LotsPositions", b =>
                {
                    b.HasBaseType("ERP.Core.Database.Domain.Entities.Bases.BasePositionsPallets");
                    ...
                    b.ToTable("lots_positions", "public");
                });
            ...
            modelBuilder.Entity("ERP.Core.Database.Domain.Entities.Catalogs.SectionPositions", b =>
                {
                    ...
                    b.ToTable("section_positions", "public");
                });
            ...
            modelBuilder.Entity("ERP.Core.Database.Domain.Entities.Operations.OperationalOrder", b =>
                {
                    ...
                    b.HasOne("ERP.Core.Database.Domain.Entities.Warehouse.ReceptionEntrance", "Reception")
                        .WithMany("OperationalOrders")
            ...
            modelBuilder.Entity("ERP.Core.Database.Domain.Entities.Shopping.PurchaseRequest", b =>
                {
                    b.HasOne("ERP.Core.Database.Domain.Entities.Auth.User", "AnnulledByUser")
                        .WithMany("AnnulledPurchaseRequests")
            ...
            modelBuilder.Entity("ERP.Core.Database.Domain.Entities.Warehouse.ReceptionTransportEntrance", b =>
                {
                    b.HasOne("ERP.Core.Database.Domain.Entities.Warehouse.ReceptionEntrance", "ReceptionEntrance")
                        .WithOne("ReceptionTransport")
                        .HasForeignKey("ERP.Core.Database.Domain.Entities.Warehouse.ReceptionTransportEntrance", "ReceptionEntranceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ERP.Core.Database.Domain.Entities.Catalogs.LotsCoordinates", b =>
                {
                    b.HasOne("ERP.Core.Database.Domain.Entities.Catalogs.Lots", "Lot")
                        .WithOne("LotsCoordinates")
                        .HasForeignKey("ERP.Core.Database.Domain.Entities.Catalogs.LotsCoordinates", "LotId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("ERP.Core.Database.Domain.Entities.Catalogs.RacksCoordinates", b =>
                {
                    b.HasOne("ERP.Core.Database.Domain.Entities.Catalogs.Racks", "Rack")
                        .WithOne("RacksCoordinates")
                        .HasForeignKey("ERP.Core.Database.Domain.Entities.Catalogs.RacksCoordinates", "RackId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("ERP.Core.Database.Domain.Entities.Catalogs.SectionCoordinates", b =>
                {
                    b.HasOne("ERP.Core.Database.Domain.Entities.Catalogs.Sections", "Section")
                        .WithOne("SectionCoordinates")
                        .HasForeignKey("ERP.Core.Database.Domain.Entities.Catalogs.SectionCoordinates", "SectionId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("ERP.Core.Database.Domain.Entities.Catalogs.Sections", b =>
                {
                    ...
                    b.Navigation("SectionCoordinates")
                        .IsRequired();
                });
