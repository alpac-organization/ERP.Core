...
namespace ERP.Core.Manager.Api.Infrastructure.Persistence.Database.Migrations
{
    ...
    [Migration("20260407225840_AgregarOpcionalCatalog")]
    partial class AgregarOpcionalCatalog
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "permit_application_type_enum", new[] { "compensatory_time", "medical_appointment", "paid_leave", "special_leave", "unpaid_leave", "vacation" });
            ...
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "public", "permit_application_type_enum", new[] { "vacation", "medical_appointment", "compensatory_time", "paid_leave", "unpaid_leave", "special_leave" });
            ...
            modelBuilder.Entity("ERP.Core.Manager.Api.Domain.Entities.Payroll.PermitApplication", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("ERP.Core.Manager.Api.Domain.Entities.Payroll.PersonalInformation", b =>
                {
                    ...
                    b.HasOne("ERP.Core.Manager.Api.Domain.Entities.Catalogs.SubCatalog", "Departament")
                        .WithMany()
