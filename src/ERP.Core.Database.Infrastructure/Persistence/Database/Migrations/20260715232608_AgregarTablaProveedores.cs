    ...
    public partial class AgregarTablaProveedores : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    suppliers_id = table.Column<Guid>(type: "uuid", nullable: false, defaultValueSql: "gen_random_uuid()"),
                    is_active = table.Column<bool>(type: "boolean", nullable: false, defaultValue: true),
                    register_by = table.Column<string>(type: "text", nullable: false),
                    suppliers_legal_name = table.Column<string>(type: "text", nullable: false),
                    identification_number = table.Column<string>(type: "text", nullable: false),
                    constitution_type = table.Column<int>(type: "constitution_type_enum", nullable: false),
