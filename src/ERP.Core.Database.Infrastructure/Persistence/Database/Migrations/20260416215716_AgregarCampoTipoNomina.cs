...
{
    /// <inheritdoc />
    public partial class AgregarCampoTipoNomina : Migration
    {
        /// <inheritdoc />
       protected override void Up(MigrationBuilder migrationBuilder)
        {
            // 1️⃣ Crear el ENUM de forma segura usando SQL nativo
            migrationBuilder.Sql(@"
                DO $$
                BEGIN
                    IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'payroll_type_enum') THEN
                        CREATE TYPE public.payroll_type_enum AS ENUM ('none', 'ordinary', 'provided');
                    END IF;
                END
                $$;
            ");

            // 2️⃣ Continuar con tus operaciones normales
            migrationBuilder.RenameColumn(
                name: "status",
                schema: "public",
                table: "payrolls",
                newName: "payroll_status");

            // ... (Mantén aquí todo el bloque de .AlterDatabase() y sus annotations) ...

            // 3️⃣ Agregar la columna apuntando al ENUM ya existente
            migrationBuilder.AddColumn<PayrollType>(
                name: "payroll_type",
                schema: "public",
                table: "payrolls",
                type: "public.payroll_type_enum",
                nullable: false,
                defaultValueSql: "'ordinary'::public.payroll_type_enum");
        }
        /// <inheritdoc />
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.AlterDatabase()
                ...
                .Annotation("Npgsql:Enum:public.payroll_type_enum", "none,ordinary,provided")
                ...
                .OldAnnotation("Npgsql:Enum:public.payroll_type_enum", "none,ordinary,provided")
