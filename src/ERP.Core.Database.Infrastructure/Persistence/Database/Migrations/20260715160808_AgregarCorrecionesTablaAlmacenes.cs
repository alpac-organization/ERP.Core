...
{
    /// <inheritdoc />
    public partial class AgregarCorrecionesTablaAlmacenes : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            // Conversión manual de integer -> enum nativo (Postgres no puede castear automáticamente)
            migrationBuilder.Sql(@"
                ALTER TABLE public.warehouses
                ALTER COLUMN warehouse_type TYPE warehouse_type_enum
                USING (
                    CASE warehouse_type
                        WHEN 1 THEN 'general'
                        WHEN 2 THEN 'fiscal'
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            // Reversión manual de enum nativo -> integer
            migrationBuilder.Sql(@"
                ALTER TABLE public.warehouses
                ALTER COLUMN warehouse_type TYPE integer
                USING (
                    CASE warehouse_type
                        WHEN 'general' THEN 1
                        WHEN 'fiscal' THEN 2
                        WHEN 'galeron_techado' THEN 3
                        WHEN 'patio_contenedores' THEN 4
                        WHEN 'predio_abierto' THEN 5
                        WHEN 'granel' THEN 6
                    END
                );
            ");
