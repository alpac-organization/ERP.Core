...
{
    /// <inheritdoc />
    public partial class AgregarBanderaViaticos : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.AlterDatabase()
                ...
                .Annotation("Npgsql:Enum:public.deduction_status_enum", "progress,completed,pending")
                ...
                .OldAnnotation("Npgsql:Enum:public.deduction_status_enum", "progress,completed,pending")
